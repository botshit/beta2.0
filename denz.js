			...
			const checkLimit = (sender) => {
				...
				try {
					const getmemex = groupMembers.length
					    ...
					    denz.sendMessage(from, `𝑁𝐸𝑀 𝐹𝑈𝑁𝐷𝐸𝑁𝐷𝑂 ??𝑈𝐸 𝐸𝑁𝑇𝑅𝑂 𝑁𝐸𝑆𝑆𝐸 𝐺𝑅𝑈𝑃𝑂 ${groupMetadata.subject} 𝑁𝐴𝑂 𝐴𝑇𝐸𝑁𝐷𝐸 𝑀𝐸𝑈𝑆 𝑅𝐸𝑄𝑈𝐼𝑆𝐼𝑇𝑂𝑆\n\n 𝑀𝐸𝑁𝐵𝑅𝑂𝑆 𝑀𝐼𝑁𝐼𝑀𝑂𝑆 ${memberLimit}`, text)
					setTimeout( () => {
...
𝑩𝑬𝑻𝑨 2.0 𝑵 𝑬́ 𝑼𝑴𝑨 𝑽𝑬𝑹𝑺𝑨𝑶 𝑶𝑭𝑰𝑪𝑰𝑨𝑳 !!!
		
🤡𝑮𝑹𝑼𝑷𝑶 𝑫𝑶 𝑩𝑶𝑻 𝑬𝑵𝑻𝑹𝑬 𝑷𝑨𝑹𝑨 𝑼𝑺𝑨𝑹 𝑺𝑬𝑴 𝑳𝑰𝑴𝑰𝑻𝑬𝑺 
🤡𝑳𝑰𝑵𝑲 :https://chat.whatsapp.com/J1ChP0au4pu0gLcFg8GiSP
...
🤡 ${prefix}𝑭𝑰𝑮 (tranforma fotos e gifs para figurinha )
🤡 ${prefix}𝑻𝑶𝑰𝑴𝑮 (tranforma figurinha n animada em foto )

͏͏͏͏͏͏͏͏͏͏͏͏͏͏              𝑭𝑼𝑵𝑪̧𝑶𝑬𝑺 𝑨𝑳𝑬𝑨𝑻𝑶𝑹𝑰𝑨𝑺

🤡 ${prefix}𝑻𝑰𝑲𝑻𝑶𝑲𝑺𝑻𝑨𝑳𝑲 (stalkea perfil no tik tok )
🤡${prefix}𝑶𝑪𝑹 (tranforma imagem em texto)
🤡${prefix}𝑻𝑶𝑴𝑷3 (tranforma video em musica)
🤡${prefix}𝑩𝑹𝑨𝑰𝑵𝑳𝒀 (usar o comando mais a pergunta )
🤡${prefix}𝑨𝑷𝑲𝑷𝑼𝑹𝑬 (usar comando mais o nome do apk)
🤡${prefix}𝑮𝑶𝑶𝑮𝑳𝑬 (comando mais oq deseja pesquisar)

                𝑴𝑬𝑵𝑼 𝑨𝑼𝑫𝑰𝑶 (modifica audios)
                
🤡${prefix}𝑮𝑬𝑴𝑼𝑲 (grave )
🤡${prefix}𝑻𝑼𝑷𝑨𝑰 (agudo)
🤡${prefix}𝑩𝑨𝑺𝑺 (estolrado)
🤡${prefix}𝑺𝑳𝑶𝑾 (lento)
🤡${prefix}𝑭𝑨𝑺𝑻  (rapido)
🤡${prefix}𝑻𝑻𝑺 𝑷𝑻-𝑩𝑹 (reproduz texto digitado)

           𝑴𝑬𝑵𝑼 𝑫𝑬 𝑶𝑻𝑨𝑲𝑼 𝑷𝑼𝑵𝑯𝑬𝑻𝑰𝑵𝑯𝑨 (menu anime)
🤡${prefix}𝑵𝑬𝑲𝑶
🤡 ${prefix}𝑳𝑶𝑳𝑰
🤡${prefix}𝑵𝑨𝑹𝑼𝑻𝑶
🤡${prefix}𝑴𝑰𝑵𝑨𝑻𝑶
...
🤡${prefix}𝑨𝑵𝑻𝑰𝑭𝑨𝑲𝑬 1/0 (banir todos os gringos que entrarem no grupo)
🤡${prefix}𝑵𝑶𝑰𝑨 (marca o zé droguinha do grupo)
🤡${prefix}𝑴𝑶𝑫𝑶𝑨𝑵𝑰𝑴𝑬 (on/off)
🤡${prefix}𝑨𝑵𝑻𝑰𝑳𝑰𝑵𝑲 (expulsa pessoas ao enviarem links )
🤡${prefix}𝑨𝑵𝑻𝑰𝑷𝑨𝑳𝑨𝑽𝑹𝑨𝑶 (expulsa pessoas ao falarem palavrões )
🤡${prefix}𝑳𝑰𝑺𝑻𝑷𝑨𝑳𝑨𝑽𝑹𝑨 (lista de palavras proibidas)
🤡${prefix}𝑩𝑬𝑴𝑽𝑰𝑵𝑫𝑶 (da boas vindas aos novos membros)
🤡${prefix}𝑪𝑹𝑰𝑨𝑫𝑶𝑹 (mostra o link do criador do grupo) 
🤡${prefix}𝑹𝑬𝑮𝑹𝑨𝑺 (mostra as informações e regras do grupo)
🤡${prefix}𝑨𝑫𝑫 (adicionar pessoa para o grupo)
🤡${prefix}𝑹𝑬𝑴𝑶𝑽𝑬𝑹 (remover pessoa do grupo)
🤡${prefix}𝑃𝑅𝑂𝑀𝑂𝑇𝐸 (promover a adm )
🤡${prefix}𝐷𝐸𝑀𝑂𝑇𝐸 (remover adm )
🤡${prefix}𝑺𝑬𝑻𝑵𝑶𝑴𝑬  (muda nome do grupo )
🤡${prefix}𝑺𝑬𝑻𝑫𝑬𝑺𝑪 (muda descrição do grupo)
🤡${prefix}𝑴𝑨𝑹𝑪𝑨𝑹𝑻𝑶𝑫𝑶𝑺 (marca todos com link junto)
🤡${prefix}𝑨𝑪𝑶𝑹𝑫𝑨 (marca todos )
🤡${prefix}𝑪𝑨𝑺𝑨𝑳 (marca um casal aleatorio no grupo)
🤡${prefix}𝑨𝑫𝑴𝑺(marca todos os adms)
🤡${prefix}𝑵𝑺𝑭𝑾 (on/off)
🤡${prefix}𝑺𝑰𝑴𝑰 (inteligência artificial )

    𝑶 𝑹𝑬𝑺𝑻𝑶 𝑭𝑰𝑪𝑨 𝑷𝑨𝑹𝑨 𝑨 𝑷𝑹𝑶𝑿𝑰𝑴𝑨 𝑨𝑻𝑼𝑨𝑳𝑰𝒁𝑨𝑪̧𝑨𝑶
...
denz.sendMessage(from, brando, MessageType.audio, {quoted: mek, mimetype: './mp3/vini', ptt:true}) 	    
            break
            case 'help':
brando = await getBuffer(`https://pencarikode.xyz/api/cita-cita?apikey=pais`, {method: 'get'})                
  ...
  break
			...
			if (!isUser) return reply(mess.only.userB)
				...
				break
					...
					teks = `𝑬𝑺𝑺𝑬 𝑬 𝑶 𝑵𝑶𝑰𝑨 𝑸𝑼𝑬 𝑽𝑬𝑵𝑫𝑬 𝑨𝑻𝑬 𝑨 𝑴𝑨𝑬 𝑸𝑼𝑨𝑵𝑫𝑶 𝑨𝑪𝑨𝑩𝑨 𝑨 𝑴𝑨𝑪𝑶𝑵𝑯𝑨 : @${beb.jid.split('@')[0]}`
					membr.push(beb.jid)
					mentions(teks, membr, true)
					break
				case 'brainly':
...
break
       ...
       exec(`wget ${anu1} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
            ...
            break  
		        ...
		        denz.sendMessage(from, buffer, image, {quoted: mek, caption: `*𝑵𝑶𝑴𝑬* : ${groupName}\n*𝑴𝑬𝑴𝑩𝑹𝑶𝑺* : ${groupMembers.length}\n*𝑨𝑫𝑴𝑺* : ${groupAdmins.length}\n*𝑹𝑬𝑮𝑹𝑨𝑺* : ${groupDesc}`})
                break
				case 'trendtwit':
					denz.updatePresence(from, Presence.composing) 
                     if (!isUser) return reply(mess.only.userB)
               ...
               denz.updatePresence(from, Presence.composing) 
              options = {
          text: `𝑬𝑺𝑺𝑬 𝑬́ 𝑶 𝑴𝑰𝑻𝑶 𝑸𝑼𝑬 𝑪𝑹𝑰𝑶𝑼 𝑶 𝑮𝑹𝑼𝑷𝑶 : wa.me/${from.split("-")[0]}`,
          contextInfo: { mentionedJid: [from] }
           ...
           denz.sendMessage(from, options, text, { quoted: mek } )
                ...
                denz.sendMessage(from, `𝑵𝑶𝑴𝑬 𝑫𝑶 𝑷𝑹𝑶𝑺𝑻𝑰𝑩𝑼𝑳𝑶 𝑨𝑳𝑻𝑬𝑹𝑨𝑫𝑶 𝑷𝑨𝑹𝑨${body.slice(9)}`, text, {quoted: mek})
                break
                case 'setdesc':
                if (isBanned) return reply(mess.only.benned)    
                if (!isUser) return reply(mess.only.userB)
                ...
                denz.sendMessage(from, `𝑫𝑬𝑺𝑪𝑹𝑰𝑪̧𝑨𝑶 𝑨𝑳𝑻𝑬𝑹𝑨𝑫𝑨 𝑺𝑬𝑼 𝑨𝑹𝑹𝑶𝑴𝑩𝑨𝑫𝑶${groupMetadata.subject}* Menjadi: *${body.slice(9)}*`, text, {quoted: mek})
                break
				case 'tts':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
         ...
         case 'lirik':
                ...
                if (args.length < 1) return reply(`Yang mau direport apaan? Contoh: #report fitur #hentai error`)
                    ...
                    reply('𝑂𝑆 𝑃𝑅𝑂𝐵𝐿𝐸𝑀𝐴𝑆 𝐹𝑂𝑅𝐴𝑀 𝑅𝐸𝐿𝐴𝑇𝐴𝐷𝑂𝑆 𝑃𝐴𝑅𝐴 𝑂 𝐷𝑂𝑁𝑂 𝐷𝑂 𝐵??𝑇, 𝑅𝐸𝐿𝐴𝑇𝑂𝑆 𝐹𝐴𝐿𝑆𝑂𝑆 𝑁 𝑆𝐸𝑅𝐴𝑀 𝑅𝐸𝑆??𝑂𝑁𝐷𝐼𝐷𝑂𝑆 ')
                    break
...
//creator
			...
			reply(mess.wait)
				...
				denz.sendMessage(from, ct, image, {caption: '𝑃𝑅𝑂𝑇𝐼𝑁𝐻?? 𝑆𝐸𝑈 𝑉𝑂𝑅𝑁𝑂', quoted: mek})
				await limitAdd(sender)
				break
				case 'slide':
				if (isBanned) return reply(mess.only.benned)    
...
case 'husbu':
        ...
        if (budy.includes("!acabou")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/acabou.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
         if (budy.includes("!nega")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/nega.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (budy.includes("!visao")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/visao.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        ...
        if (budy.includes("!espirra")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/espirra.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        if (budy.includes("!kalli")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/kalli.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
         if (budy.includes("!tapa")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/tapa.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
        ...
        if (budy.includes("!rama")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/rama.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
